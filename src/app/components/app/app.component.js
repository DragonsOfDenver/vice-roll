...
const metadata = {
    name: 'Vice Roll Casino',
    description: 'casino for public good',
    url: 'https://viceroll.casino', // origin must match your domain & subdomain
    icons: ['https://avatars.githubusercontent.com/u/111'],
};
